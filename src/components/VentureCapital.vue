  ...
  <div>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <span style="margin-left: 10px" v-if="scope.row.status=='FIRST_TRIAL'">
          初审
        </span>
          <span style="margin-left: 10px;" v-if="scope.row.status=='RECHECK'" >
          复审
        </span>
          <span style="margin-left: 10px;" v-if="scope.row.status=='NO_CHECK'" >
          不通过
        </span>
          <span style="margin-left: 10px;" v-if="scope.row.status=='CHECH_PASS'" >
          已完成
        </span>
